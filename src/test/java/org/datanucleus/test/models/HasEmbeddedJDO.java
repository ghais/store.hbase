...
public class HasEmbeddedJDO
{
    ...
    @Persistent
    @Embedded(members = {@Persistent(name = "id", columns = @Column(name = "ID")),
            @Persistent(name = "origin", columns = @Column(name = "ORIGIN")), @Persistent(name = "dest", columns = @Column(name = "DEST")),
            @Persistent(name = "name", columns = @Column(name = "NAME")), @Persistent(name = "you", columns = @Column(name = "YOU")),
    ...
    @EmbeddedOnly
    @PersistenceCapable(table = "Embedded1")
    ...
    @EmbeddedOnly
    @PersistenceCapable(table = "Embedded2")
