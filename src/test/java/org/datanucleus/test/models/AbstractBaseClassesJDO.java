...
public class AbstractBaseClassesJDO
{
    ...
    @PersistenceCapable(identityType = IdentityType.APPLICATION, table = "Base1")
    ...
    @PersistenceCapable(identityType = IdentityType.APPLICATION, table = "Concrete1")
    ...
    @PersistenceCapable(identityType = IdentityType.APPLICATION, table = "Base2")
    @Inheritance(strategy = InheritanceStrategy.SUBCLASS_TABLE)
    ...
    @PersistenceCapable(identityType = IdentityType.APPLICATION, table = "Concrete2")
    ...
    @PersistenceCapable(identityType = IdentityType.APPLICATION, table = "Concrete3")
    ...
    @PersistenceCapable(identityType = IdentityType.APPLICATION, table = "Concrete4")
